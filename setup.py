...
setup(
    name='pytorch_tools', # the name of the package, which can be different than the folder when using pip instal
    version='1.0.0',
    description='Utility modules for pytorch geometric and pytorch models',
