...
def read_graph(dataset_str): # {'pubmed', 'citeseer', 'cora'}
    ...
    for u in G.nodes():
            G.nodes[u]['feat'] = np.array(features[u])
...
#        
#        for u in G.nodes():
#            node_labels.append(G.nodes[u]['atomic_num'])
#        graphs.append(G)
#
